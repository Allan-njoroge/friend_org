  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-none ring-offset-background transition-opacity hover:opacity-100  focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
